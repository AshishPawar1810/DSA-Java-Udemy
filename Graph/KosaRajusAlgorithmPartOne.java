...
/*
KosaRajusAlgorithm :
Kosa raju's algortihm is used to strongly connected component
You have given directed graph
you need to print node which are reverse rechable
eg. 0-->1<==>2
print : 0
        1 2
 */
public class KosaRajusAlgorithmPartOne {
    ...
    public static void main(String[] args) {
        ...
        KosaRajusAlgorithmPartOne obj = new KosaRajusAlgorithmPartOne();
        int V = 5;
